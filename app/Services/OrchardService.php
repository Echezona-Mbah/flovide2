...
class OrchardService
{
    ...
    public function sendPayment(array $payload): array
    {
        if (!$this->isConfigured()) {
            Log::warning('[Orchard] sendPayment called but Orchard is not configured');
            return ['success' => false, 'error' => 'Orchard service is not configured'];
        }
    ...
    {
        if (!$this->isConfigured()) {
            Log::warning('[Orchard] accountInquiry called but Orchard is not configured');
            return ['success' => false, 'error' => 'Orchard service is not configured'];
        }
    ...
    {
        if (!$this->isConfigured()) {
            Log::warning('[Orchard] checkTransaction called but Orchard is not configured');
            return ['success' => false, 'error' => 'Orchard service is not configured'];
        }
