        ...
        <div class="mt-16 flex flex-col md:flex-row md:justify-between items-center gap-6 md:gap-0 mx-auto">
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-1">
              ...
              <svg class="w-5 h-5 text-yellow-400/90" fill="currentColor" viewbox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.974a1 1 0 00.95.69h4.18c.969 0 1.371 1.24.588 1.81l-3.388 2.462a1 1 0 00-.364 1.118l1.287 3.974c.3.922-.755 1.688-1.54 1.118l-3.388-2.462a1 1 0 00-1.175 0l-3.388 2.462c-.784.57-1.838-.196-1.539-1.118l1.287-3.974a1 1 0 00-.364-1.118L2.045 9.4c-.783-.57-.38-1.81.588-1.81h4.18a1 1 0 00.95-.69l1.286-3.974z">
                </path>
    ...
    <section class="max-w-7xl mx-auto w-full px-6 py-12 md:py-20">
      <div class="flex flex-col md:flex-row items-center md:items-start gap-10 md:gap-20">
        <img alt="Two people fist bumping over a wooden table with charts and laptop in background"
          ...
          src="../asserts/Personal/about_us.png" width="600" />
        <div class="max-w-xl pt-4">
          ...
          {{-- <div class="flex space-x-10 justify-between items-center md:space-x-20 text-gray-800">
            <div>
        ...
        <article class="bg-[#F2F2F2] rounded-3xl flex flex-col">
          ...
          <section>
            <img
              ...
              class="rounded-t-xl w-full flex-grow px-10" height="200px" src="../asserts/homepage/blog_img2.png"
              width="200px" />
          </section>
        </article>
        <!-- Card 3 -->
        <article class="bg-[#F2F2F2] rounded-3xl flex flex-col relative">
          ...
          <section class="flex justify-start items-start w-full absolute bottom-0">
            <img
              ...
              class="rounded-t-xl w-full flex-grow px-10" height="200px" src="../asserts/homepage/blog_img3.png"
              width="200px" />
          </section>
        </article>
        <!-- Card 4 -->
        <article class="bg-[#F2F2F2] rounded-3xl flex flex-col">
          ...
          <section>
            <img alt="Father and two children using tablet outdoors in park representing funds remittance"
              class="rounded-t-xl w-full flex-grow px-10" height="200px" src="../asserts/homepage/blog_img4.png"
              width="200px" />
          </section>
        </article>
      </section>
        ...
        <div class="max-w-7xl mx-auto px-6 py-16 rounded-3xl">
          ...
          <div class="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
            ...
            {{-- <div
              ...
              <div class="p-8">
                <div class="mb-6">
                  <img src="../asserts/basic_good.svg" alt="Basic Plan Icon" class="w-6 h-6" />
                </div>
            ...
            {{-- <div
              ...
              <div class="p-8">
                <div class="mb-6">
                  <img src="../asserts/solar_star-broken.svg" alt="star icon" class="w-6 h-6" />
                </div>
            ...
            {{-- <div
              ...
              <div class="p-8">
                <div class="mb-6">
                  <img src="../asserts/enterprice_icon.svg" alt="enterprice_icon Icon" class="w-6 h-6" />
                </div>
              ...
              <template id="testimonial-card">
                ...
                <article
                  ...
                  <p class="mb-8 text-base leading-relaxed">
                    ...
                    place. Managing my business payments in USD and EUR has never been smoother.
                  </p>
                  <div class="flex items-center gap-4">
