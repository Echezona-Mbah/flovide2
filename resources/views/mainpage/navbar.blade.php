<nav class="">
  ...
  <section class="hidden md:flex items-center justify-between px-6 py-4 max-w-[1200px] mx-auto">
    ...
    <ul class="hidden md:flex space-x-8 text-sm font-medium text-gray-800">
      <li>
        <a class="{{ Route::currentRouteName() === 'personal' ? 'text-[#1D4ED8] font-semibold' : 'hover:text-gray-900' }}" href="{{ route('personal') }}">
          Personal
        </a>
      </li>
      <li>
        <a class="{{ Route::currentRouteName() === 'business' ? 'text-[#1D4ED8] font-semibold' : 'hover:text-gray-900' }}" href="{{ route('business') }}">
          Business
        </a>
      </li>
      <li>
        <a class="{{ Route::currentRouteName() === 'developer' ? 'text-[#1D4ED8] font-semibold' : 'hover:text-gray-900' }}" href="">
          Developer
        </a>
      </li>
      <li>
        <a class="{{ Route::currentRouteName() === 'blog' ? 'text-[#1D4ED8] font-semibold' : 'hover:text-gray-900' }}" href="">
          Blog
        </a>
      </li>
      <li>
        <a class="{{ Route::currentRouteName() === 'contact' ? 'text-[#1D4ED8] font-semibold' : 'hover:text-gray-900' }}" href="">
          Contact Us
        </a>
      </li>
    </ul>
    ...
    <div class="flex items-center space-x-6 text-sm font-medium text-gray-800">
      <!-- Country selector -->
      <button aria-label="Select country" class="flex items-center space-x-2 border border-[#1D4ED8] rounded-full px-3 py-1 text-[#252525] hover:bg-[#E0E7FF] focus:outline-none" type="button">
