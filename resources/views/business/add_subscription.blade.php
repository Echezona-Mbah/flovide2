                ...
                <div class="w-full">
                    ...
                    <section class="flex items-center justify-between mb-8">
                        <div class="flex items-center gap-2 md:gap-4">
                            ...
                            <h1 class="font-semibold md:text-xl text-md text-gray-900">Subscription details</h1>
                        </div>
                    ...
                    <main class="flex flex-col lg:flex-row gap-10">
                        ...
                        <section class="flex-1 max-w-lg">
                            ...
                            <form method="POST" action="{{ route('add_subscription.store') }}" class="space-y-6" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div>
                                    <label for="cover-image" class="block mb-2 text-sm font-medium text-gray-700">Add a
                                        cover image</label>
                                    <div class="flex flex-wrap gap-2 mb-2 text-xs text-gray-500">
                                        <span class="inline-block border border-gray-300 rounded px-2 py-0.5">
                                    ...
                                    <label for="cover-image"
                                        ...
                                        <span
                                            class="absolute top-2 left-2 text-xs text-gray-400 select-none pointer-events-none">Drag
                                            and
                                            drop
                                            here or</span>
                                        <button type="button"
