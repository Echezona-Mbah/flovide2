            ...
            <section
                ...
                <header class="flex items-center gap-4 mb-8">
                    ...
                    <div class="ml-auto flex items-center gap-4">
                        ...
                        <button type="button"
                            class="md:flex hidden items-center gap-2 rounded-lg border border-gray-300 bg-gray-100 px-4 py-2 text-gray-500 text-sm font-semibold">
                ...
                <main class="flex flex-col lg:flex-row gap-10">
                    ...
                    <section class="flex-1 max-w-full lg:max-w-[600px] flex flex-col gap-6">
                        ...
                        <form class="flex flex-col gap-6" action="{{ route('donation.store') }}" method="POST"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div id="upload-container"
                                    class="relative cursor-pointer mt-2 border border-dashed border-gray-300 rounded-md h-28 flex flex-col items-center justify-center text-xs text-gray-600 select-none hover:border-gray-400">
                                    ...
                                    <div id="upload-label" class="flex flex-col items-center">
                                        ...
                                        <button type="button" id="browse-btn"
                                            class="mt-1 bg-blue-700 text-white text-xs font-semibold px-3 py-1 rounded-md">
                                    ...
                                    <!-- Image Preview -->
                                    <div id="preview"
                                        class="hidden relative w-full h-full flex items-center justify-center">
                                        <img id="preview-img" class="max-h-24 object-contain rounded-md" />
                                        <!-- Remove Button -->
                                        <button type="button" id="remove-btn"
                                            class="absolute top-2 right-2 bg-red-600 text-white text-xs px-2 py-1 rounded-md shadow">
                                            Remove
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input id="title" type="text" name="title" placeholder="Enter Donation Title"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <input type="number" name="amount" placeholder="Enter Donation Amount"
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <input type="number" name="percentage" value="10"
                    ...
                    <section class="flex-1 max-w-full lg:max-w-[520px] flex flex-col gap-4">
                        <div class="flex justify-between items-center">
                            ...
                            <button type="button"
                                class="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-500 text-sm font-semibold">
                                <i class="fas fa-file-export"></i>
                                Export CSV
                            </button>
                        </div>

                        <div class="md:flex-1 md:overflow-y-auto w-full overflow-x-auto pr-2 bg-[#F3F3F3] p-4 rounded-2xl flex items-center justify-center"
