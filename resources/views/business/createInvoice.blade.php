                                ...
                                <form id="invoiceForm" method="POST">
                                    ...
                                    <div class="flex flex-wrap gap-4 mt-3 mb-4">
                                        <div class="flex-1 min-w-[150px]">
                                            ...
                                            <input id="invoiceNumber" type="text" value="" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-[#3B82F6] focus:border-[#3B82F6]" />
                                        </div>
                                        <div class="flex-1 min-w-[150px]">
                                            <label for="dueDate"
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <textarea id="note" rows="4" class="w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 resize-none focus:outline-none focus:ring-1 focus:ring-[#3B82F6] focus:border-[#3B82F6]"></textarea>
                                    </div>
