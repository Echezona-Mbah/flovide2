            ...
            <section
                ...
                <section class="flex flex-col md:flex-row gap-10 mx-auto max-w-full min-h-screen">
                        ...
                        <table class="w-full text-left text-sm text-gray-600 border-separate border-spacing-y-1">
                            ...
                            <tbody id="customerTableBody">
                                ...
                                <tr onclick="loadCustomerDetails({{ $customer->id }})"
                                    ...
                                    data-id="{{ $customer->id }}">
                                    <td class="pl-4 py-3">{{ $customer->name }}</td>
                    ...
                    <div class="w-full md:w-96 border-l border-gray-200 p-6 md:p-10">
                        ...
                        <h2 id="customerName" class="text-2xl font-normal mb-6">Jane Awesome</h2>

                            <div class="space-y-6 text-sm text-gray-700">
                                <div>
                                    <p class="text-gray-400 text-xs mb-1">Date Added</p>
                                    <p id="customerDate" class="font-semibold text-base text-gray-900">Aug 6, 2025</p>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <div>
                                        <p class="text-gray-400 text-xs mb-1">Email</p>
                                        <p id="customerEmail" class="font-semibold text-base text-gray-900 inline-block">janedo@gmail.com</p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <div>
                                        <p class="text-gray-400 text-xs mb-1">Phone</p>
                                        <p id="customerPhone" class="font-semibold text-base text-gray-900 inline-block">1234567890</p>
                                    </div>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-xs mb-1">Bank</p>
                                    <p id="customerBank" class="font-semibold text-base text-gray-900">Zenith</p>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-xs mb-1">Account name</p>
                                    <p id="accountName" class="font-semibold text-base text-gray-900">Jane Do</p>
                                </div>
                                <div>
                                    <p class="text-gray-400 text-xs mb-1">Bank country</p>
                                    <p id="bankCountry" class="font-semibold text-base text-gray-900">Nigeria</p>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <div>
                                        <p class="text-gray-400 text-xs mb-1">Bank account number</p>
                                        <p id="accountNumber" class="font-semibold text-base text-gray-900 inline-block">1234567890</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mt-10 flex space-x-4">
                            <button type="button"
                                class="inline-flex items-center space-x-2 rounded-lg bg-blue-100 px-6 py-2 text-blue-700 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300">
                                <i class="fas fa-pen"></i>
                                <span>Edit</span>
                            </button>
                            <button type="button"
                                class="inline-flex items-center space-x-2 rounded-lg bg-red-100 px-6 py-2 text-red-600 hover:bg-red-200 focus:outline-none focus:ring-2 focus:ring-red-300">
            ...
            fetch(`/customers/${id}`)
                ...
                .then(data => {
                    if (data.data) {
                        ...
                        document.querySelector('#customerDate').innerText = new Date(customer.created_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' });
