    ...
    <main class="md:relative md:top-[3vh] right-0 left-0 mx-auto space-y-10 md:space-y-20 overflow-x-hidden">
        ...
        <main class="relative top-[-30vh] flex justify-center">
            <div class="bg-white w-full max-w-2xl rounded-xl shadow-lg p-8">
                <h2 class="text-2xl font-bold text-center mb-6"> {{ ucfirst($donation->title) }}</h2>
           ...
           11.54L12 21.35z" />
                ...
                <!-- Form -->
                <form class="space-y-4" method="post" action="donation.pay">
                    @csrf
                    <div>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1">Donation Amount</label>
                        <input type="email" name="email" placeholder="{{ $donation->currency }} 100"
                            class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    ...
                    <div class="flex space-x-4">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="expirationDate" placeholder="MM / YYYY"
                                class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div class="w-1/2">
                            <label class="block text-sm font-medium mb-1">Security Code</label>
                            <input type="text" name="SecurityCode" placeholder="000"
                                class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    ...
                    <button type="submit"
                        class="w-36 bg-blue-700 text-white py-2 rounded-3xl hover:bg-blue-700">Pay</button>
                </form>
            </div>
        </main>
