        ...
        <main class="flex flex-col lg:flex-row gap-10">
          ...
          <section class="flex-1 max-w-full lg:max-w-[600px] flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-1">
              ...
              <label for="cover-upload" class="mt-2 cursor-pointer border border-dashed border-gray-300 rounded-md h-16 flex items-center justify-center text-xs text-gray-600 select-none hover:border-gray-400">
            ...
            <form class="flex flex-col gap-6" action="{{ route('remita.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="flex flex-col gap-1">
                ...
                <input id="title" type="text" placeholder="Enter Remita Title" class="text-xs text-gray-400 rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500" />
              </div>
