        ...
        <section class=" relative w-full ">
                        ...
                        <form class="space-y-6">
                            <div>
                                ...
                                <select id="bank" name="bank"
                                    class="w-full rounded-lg border border-gray-300 text-gray-900 text-sm px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
                                    <option>GTBank</option>
                                </select>
                            </div>
                        
                            <div>
                                <label for="country" class="block text-gray-600 text-sm font-semibold mb-1">In what country is your
                                    bank located?</label>
                            ...
                            <div>
                                <label for="account-number" class="block text-gray-600 text-sm font-semibold mb-1">Bank account
                                    number</label>
                            ...
                            <div>
                                <label for="account-name" class="block text-gray-600 text-sm font-semibold mb-1">Bank account
                                    name</label>
                            ...
                            <div class="flex gap-4">
                                <button type="submit"
                                    class="bg-blue-300 text-blue-800 font-semibold text-sm rounded-full px-6 py-2 hover:bg-blue-400 transition">
                                    Update Account
                                </button>
                                <button type="button"
                                    class="border border-gray-300 rounded-full px-6 py-2 text-sm font-normal text-black hover:bg-gray-100 transition">
                                    Cancel
                                </button>
                            </div>
                        </form>
            ...
            <section class="flex-1 max-w-lg bg-gray-100 rounded-2xl p-6  flex flex-col gap-4">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button type="button"
                        class="flex items-center gap-2 bg-white rounded-full px-4 py-2 text-red-600 text-sm font-semibold hover:bg-red-50 transition">
                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li class="flex items-center gap-4 border border-blue-500 rounded-xl bg-white px-4 py-3">
                        ...
                        <span class="font-semibold text-gray-900 text-base">2100048486</span>
                        <span class="bg-gray-200 text-gray-700 text-xs rounded-full px-2 py-0.5">GTBank</span>
                    </li>
            
                    <!-- Account 2 -->
                    <li class="flex items-center gap-4 bg-white rounded-xl px-4 py-3">
                        <div class="flex justify-center items-center w-10 h-10 rounded-lg bg-gray-300 text-gray-600">
                            <i class="fas fa-check"></i>
                        </div>
                        <span class="font-semibold text-gray-900 text-base">2100048486</span>
                        <span class="bg-gray-200 text-gray-700 text-xs rounded-full px-2 py-0.5">Zenith</span>
                        <button type="button" class="ml-auto text-gray-600 hover:text-gray-900" aria-label="Edit account">
                            <i class="fas fa-pencil-alt"></i>
                        </button>
                        <button type="button" class="text-gray-600 hover:text-gray-900" aria-label="Delete account">
                    ...
                    <li class="flex items-center gap-4 bg-white rounded-xl px-4 py-3">
                        ...
                        <span class="font-semibold text-gray-900 text-base">12345678901</span>
                        <span class="bg-gray-200 text-gray-700 text-xs rounded-full px-2 py-0.5">UBA</span>
                        <button type="button" class="ml-auto text-gray-600 hover:text-gray-900" aria-label="Edit account">
                            <i class="fas fa-pencil-alt"></i>
                        </button>
                        <button type="button" class="text-gray-600 hover:text-gray-900" aria-label="Delete account">
