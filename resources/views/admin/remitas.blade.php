...
<body>
                        ...
                        <div class="page-title-heading">
                            ...
                            <div>
                                ...
                                <div class="page-title-subheading">
                                    View and manage all Remita campaigns, including total goals, contributors, and currency.
                                </div>
                            </div>
    ...
    <div class="main-card mb-3 card"> 
        ...
        <div class="table-responsive">
            <table class="align-middle table table-borderless table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">{{ $remita->title }}</td>
                        <td class="text-center">{{ number_format($remita->amount) }}</td>
                        <td class="text-center">{{ strtoupper($remita->currency) }}</td>
                        <td class="text-center">{{ ucfirst($remita->visibility) }}</td>



                        <td>
                            <a href="{{ url('/admin/remita/'.$remita->id) }}" 
        ...
        <div class="mt-3">
            {{ $remitas->links('pagination::bootstrap-5') }}
        </div>
