        ...
        <div class="page-title-heading">
            ...
            <div>
                ...
                <div class="page-title-subheading">
                    Review all contributions for a specific Items campaign, including donor details, amounts, and statuses.
                </div>
            </div>
 ...
 <div class="main-card mb-3 card"> 
    <div class="card-header">
        <div class="card-header-title font-size-lg fw-normal">
            Invoice Items            {{ $invoice->title }}
        Total Goal: {{ number_format($invoice->amount) }} {{ $invoice->currency }}
        </div>
    </div>
        ...
        <table class="align-middle table table-borderless table-hover mb-0">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Rate enabled</th>
                </tr>
            </thead>
