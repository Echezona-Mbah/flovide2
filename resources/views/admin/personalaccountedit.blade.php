                        ...
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div class="page-title-icon">
                                    <i class="pe-7s-user icon-gradient bg-ripe-malin"></i>
                                </div>
                                <div>
                                    Personal Account Edit
                                    <div class="page-title-subheading">
                                        Review and update personal user information, location details, and account status.
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-8">
                                        ...
                                        <p class="text-white-50 mb-0" style="max-width: 700px; line-height: 1.8;">
                                            Manage this personal account in a cleaner workspace with organized sections for identity, contact, and location details.
                                        </p>
                                    </div>
                                ...
                                <div class="col-xl-8">
                                    <div class="card edit-card">
                                        <div class="card-header">
                                            ...
                                            <p class="mb-0 text-muted">Update the personal account details below.</p>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="section-card">
                                                ...
                                                <div class="section-subtitle">Basic identity and contact details for this user.</div>
                                            ...
                                            <div class="section-card">
                                                ...
                                                <div class="section-subtitle">Residential and location-related information.</div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <input type="text" name="country" class="form-control custom-input" value="{{ $user->country }}">
                                                    </div>
