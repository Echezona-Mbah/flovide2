        ...
        <div class="page-title-heading">
            ...
            <div>
                ...
                <div class="page-title-subheading">
                    Review all contributions for a specific subscription campaign, including donor details, amounts, and statuses.
                </div>
            </div>
 ...
 <div class="main-card mb-3 card"> 
    <div class="card-header">
        <div class="card-header-title font-size-lg fw-normal">
            subscription Records            {{ $subscription->title }}
        Total Goal: {{ number_format($subscription->amount) }} {{ $subscription->currency }}
        </div>
    </div>
