                        ...
                        <div class="page-title-heading">
                            ...
                            <div>
                                ...
                                <div class="page-title-subheading">
                                    View and manage all Subscription campaigns, including total goals, contributors, and currency.
                                </div>
                            </div>
            ...
            <table class="align-middle table table-borderless table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ number_format($subscription->amount) }}</td>
                        <td class="text-center">{{ strtoupper($subscription->currency) }}</td>
                        <td class="text-center">{{ ucfirst($subscription->visibility) }}</td>
