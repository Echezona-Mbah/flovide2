...
<input type="text" name="incorporation_date" class="form-control"
value="{{ $user->incorporation_date }}">
</div>
<!-- Annual Turnover -->
<div class="col-md-6 mb-3">
<label>Annual Turnover</label>
<input type="text" name="annual_turnover" class="form-control"
value="{{ $user->annual_turnover }}">
</div>
...
<input type="text" name="trading_address" class="form-control"
value="{{ $user->trading_address }}">
</div>
...
<div class="col-md-6 mb-3">
<label>Country</label>
<input type="text" name="countries_id" class="form-control"
value="{{ $user->countries_id }}">
</div>
