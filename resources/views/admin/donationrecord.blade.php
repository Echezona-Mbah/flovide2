        ...
        <div class="page-title-heading">
            ...
            <div>
                ...
                <div class="page-title-subheading">
                    Review all contributions for a specific donation campaign, including donor details, amounts, and statuses.
                </div>
            </div>
 ...
 <div class="main-card mb-3 card"> 
    <div class="card-header">
        <div class="card-header-title font-size-lg fw-normal">
            Donation Records            {{ $donation->title }}
        Total Goal: {{ number_format($donation->amount) }} {{ $donation->currency }}
        </div>
    </div>
