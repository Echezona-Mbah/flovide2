                            ...
                            <ul class="list-group">
                                    ...
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left me-3">
                                                <div class="form-check form-switch switch-container-class" data-class="fixed-header">
                                                    <input class="form-check-input" type="checkbox" checked id="fixed-header-switch">
                                                    <label class="form-check-label" for="fixed-header-switch"></label>
                                                </div>
                                            </div>
                                ...
                                <li class="list-group-item">
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left me-3">
                                                <div class="form-check form-switch switch-container-class" data-class="fixed-sidebar">
                                                    <input class="form-check-input" type="checkbox" checked id="fixed-sidebar-switch">
                                                    <label class="form-check-label" for="fixed-sidebar-switch"></label>
                                                </div>
                                            </div>
                                            <div class="widget-content-left">
                                ...
                                <li class="list-group-item">
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left me-3">
                                                <div class="form-check form-switch switch-container-class" data-class="fixed-footer">
                                                    <input class="form-check-input" type="checkbox" id="fixed-footer-switch">
                                                    <label class="form-check-label" for="fixed-footer-switch"></label>
                                                </div>
                                            </div>
                                            <div class="widget-content-left">
